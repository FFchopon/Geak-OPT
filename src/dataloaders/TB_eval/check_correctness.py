...
## check if a GPU visibility environment variable is set
assert (
    'CUDA_VISIBLE_DEVICES' in os.environ or 'HIP_VISIBLE_DEVICES' in os.environ
), "CUDA_VISIBLE_DEVICES/HIP_VISIBLE_DEVICES environment variable is not set. Please set it to the GPU you want to use."
